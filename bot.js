...
fs.writeFile("./creditsCode.json", JSON.stringify(credits), (err) => {
  ...
  credits[message.author.id] = {
    ...
    if(message.content.startsWith(prefix + "creditsty"	|| prefix + "creditsty")) {
message.channel.send(`**${message.author.username}, your :credit_card: balance is \`\`${userData.creditsty}\`\`.**`);
}
});
